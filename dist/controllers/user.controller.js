...
exports.userController = {
  findAll(_, res) {
    try {
      return (0, jsonResponse_1.jsonResponse)(
        res,
        200,
        user_service_1.userService.findAll()
      );
    } catch (e) {
      const error = e;
  ...
  findOne(_, res, { params }) {
    try {
      ...
      if (!id || !(0, uuid_1.validate)(id) || typeof id !== "string") {
        return (0, jsonResponse_1.jsonResponse)(res, 400, {
      ...
      return (0, jsonResponse_1.jsonResponse)(
        res,
        200,
        user_service_1.userService.findOne(id)
      );
    } catch (e) {
      const error = e;
      (0, jsonResponse_1.jsonResponse)(res, error.status, error);
  ...
  async create(_, res, { body }) {
    try {
      if (!(0, user_validator_1.isValidCreateUserDto)(body)) return;
  ...
  update(_, res, { params, body }) {
    try {
      ...
      if (!(0, user_validator_1.isValidUpdateUserDto)(body)) return;
      return (0, jsonResponse_1.jsonResponse)(
        res,
        200,
        user_service_1.userService.update(id, body)
      );
    } catch (e) {
      const error = e;
      (0, jsonResponse_1.jsonResponse)(res, error.status, error);
  ...
  delete(_, res, { params }) {
    try {
      ...
      return (0, jsonResponse_1.jsonResponse)(
        res,
        204,
        user_service_1.userService.delete(id)
      );
    } catch (e) {
      const error = e;
